...
class Constant:
    ...
    # Publish to Subscriptions Feed Deselect
    SHOW_MORE_BUTTON = '//*[@id="toggle-button"]'
    PUBLISH_TO_SUBSCRIPTIONS_TOGGLE = '//*[@id="notify-subscribers"]'
    # also can use id = 'toggle-button' and 'notify-subscribers' as they are unique
